...
fig.tight_layout()
fig.savefig("../Figures/pop_by_inun_change_high_boxen_.png")
...
ax1.set_ylabel('Population Change')
fig.tight_layout()
fig.savefig("../Figures/pop_by_inun_change_low_boxen_.png")
...
ax1.set_ylabel('Population Change')
fig.tight_layout()
fig.savefig("../Figures/pop_by_inun_change_high_scatter_.png")
...
ax1.set_ylabel('Population Change')
fig.tight_layout()
fig.savefig("../Figures/pop_by_inun_change_low_scatter_.png")
